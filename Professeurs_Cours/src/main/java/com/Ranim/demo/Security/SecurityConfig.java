...
public class SecurityConfig  extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests().antMatchers("/saveProfesseur").hasAnyRole("ADMIN", "AGENT");
		http.authorizeRequests().antMatchers("/ListeProfesseurs").hasAnyRole("ADMIN", "AGENT", "USER");

		http.authorizeRequests().antMatchers("/supprimerProfesseur", "/modifierProfesseur", "/updateProfesseur")
				.hasAnyRole("ADMIN");
